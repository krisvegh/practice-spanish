...
const dictionary: Dictionary = [
  ...
  { spanish: ["la cucharita", "la cucharilla"], english: "teaspoon", verb: false },
  ...
  { spanish: ["la pasta de dientes", "la pasta dentífrica"], english: "toothpaste", verb: false },
  ...
  { spanish: ["correos", "officina de correos"], english: "post office", verb: false },
  ...
  { spanish: ["entender", "comprender"], english: "to understand", verb: false },
  { spanish: ["romper"], english: "to break", verb: false },
  { spanish: ["toser"], english: "to couogh", verb: false },
  { spanish: ["correr"], english: "to run", verb: false },
  { spanish: ["tener", "deber"], english: "have to / should do sth", verb: false },
  ...
  { spanish: ["el cuarto", "la habitación", "el dormitorio"], english: "bedroom", verb: false },
];
