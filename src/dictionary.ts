...
const dictionary: Dictionary = [
  { spanish: ["este", "esta", "esto"], english: "this" },
  ...
  { spanish: ["timido", "vegonzoso"], english: "shy" },
  ...
  { spanish: ["creer", "pensar"], english: "to think / believe" },
  ...
  { spanish: ["jugar", "tocar"], english: "to play" },
  { spanish: ["empezar", "comenzar"], english: "to begin / start" },
  { spanish: ["decir"], english: "to say / tell" },
  { spanish: ["poder", "ser capaz de"], english: "to be able to / can" },
  ...
  { spanish: ["tacaño", "rata"], english: "cheap person" },
  ...
  { spanish: ["el marido", "el esposo"], english: "husband" },
  { spanish: ["la mujer", "la esposa"], english: "wife" },
  ...
  { spanish: ["los fuegos", "la vitrocerámica", "la vitro"], english: "stove" },
  { spanish: ["el horno"], english: "oven" },
  { spanish: ["la nevera", "el frigorífico"], english: "refrigerator" },
  ...
  { spanish: ["el cristal", "el vídrio"], english: "glass (as a material)" },
  ...
  { spanish: ["devolver", "descambiar"], english: "return, repay" },
  { spanish: ["feo"], english: "ugly" },
  { spanish: ["gordo"], english: "fat" },
  { spanish: ["flaco"], english: "skinny" },
  { spanish: ["guapo"], english: "handsome" },
  { spanish: ["perezoso", "vago", "flojo"], english: "lazy" },
  ...
  { spanish: ["difícil", "complicado"], english: "difficult" },
  ...
  { spanish: ["quiénes son"], english: "why are..." },
  { spanish: ["mismo", "misma"], english: "same" },
  { spanish: ["todo", "toda"], english: "all / everything" },
  { spanish: ["horario", "calendario"], english: "schedule" },
  { spanish: ["aprender"], english: "to learn" },
  ...
  { spanish: ["traer", "llevar"], english: "to carry / bring" },
  { spanish: ["poner"], english: "to put" },
  ...
  { spanish: ["llegar", "alcanzar"], english: "get (to), reach, arrive" },
  ...
  { spanish: ["guarro", "cochina", "cochino"], english: "filthy / dirty" },
  { spanish: ["sucio"], english: "dirty" },
  { spanish: ["ocupada", "ocupado"], english: "busy" },
  { spanish: ["desde"], english: "since / from" },
  { spanish: ["por supuesto", "desde luego"], english: "of course" },
