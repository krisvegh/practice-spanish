...
export type ExtendedVerbMeta = Verb & { person: string };

export interface Word {
  english: string;
  spanish: string[];
  meta?: ExtendedVerbMeta;
}
...
const dictionary: Dictionary = [
  { spanish: ['esta', 'este', 'esto'], english: 'this' },
...
export const getWordlist = (wordLimit: number) => {
  return getRandomElements(dictionary, wordLimit);
};
